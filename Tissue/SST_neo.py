...
class SSTcell:
    ...
    def setParameters(self):
        ...
        # self.y[0] = -73.55#self.E_leak
        # self.y[1] = 0.9363#self.alpha_h_OLM(self.y[0]) / (self.alpha_h_OLM(self.y[0]) + self.beta_h_OLM(self.y[0]))
        # self.y[2] = 0.0409#self.alpha_n_OLM(self.y[0]) / (self.alpha_n_OLM(self.y[0]) + self.beta_n_OLM(self.y[0]))
        # self.y[3] = 0.000203
        # self.y[4] = 0.349# self.H_inf_OLM(self.y[0]) * self.tau_H_OLM(self.y[0])
        # self.y[5] = 9.5
